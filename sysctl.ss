...
(define ctlflag_rd #x80000000)
(define ctlflag_wr #x40000000)
(define ctlflag_dormant #x20000000)
(define ctlflag_anybody #x10000000)
(define ctlflag_secure #x08000000)
(define ctlflag_prison #x04000000)
(define ctlflag_dyn #x02000000)
(define ctlflag_skip #x01000000)
(define ctlmask_secure #x00f00000)
(define ctlflag_tun #x00080000)
(define ctlflag_mpsafe #x00040000)
(define ctlflag_vnet #x00020000)
(define ctlflag_dying #x00010000)
(define ctlflag_caprd #x00008000)
(define ctlflag_capwr #x00004000)
(define ctlflag_stats #x00002000)
(define ctlflag_nofetch #x00001000)
(define ctlflag_needgiant #x00000800)
	...
	(let* ([kind (ftype-ref unsigned-int () bufp)]
	  ...
	  (if (equal? type #x1)	; CTLTYPE_NODE
		...
		(case type
		  ...
		  [#x5 (do ([i 0 (+ i 1)])
			   ((= i size))
			 (foreign-set! 'unsigned-8 bufp i (bytevector-ref value i)))]
		  ;; CTLTYPE_UINT
